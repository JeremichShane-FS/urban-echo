/**
 * Test file for GitHub issue automation
 * This file contains various TODO/FIX comments to test the automation workflow
 *
 * Expected Results:
 * ✅ Valid comments should create properly labeled issues
...
// TODO: [SECURITY] Implement rate limiting for API endpoints
...
// TODO: [ROUTES] Create user management API endpoints
...
// FIX: [PERF] Database queries causing performance bottleneck
...
// TODO: [COMPONENT] Add 中文 support for international users
// Should fail validation - contains non-English characters

// TODO: [SECURITY] Fix $variable & command execution vulnerability
// Should fail validation - contains special characters $ and &

// ===== EDGE CASES TO TEST =====

// TODO: [component] lowercase template should be normalized to uppercase
// This should work and template should become [COMPONENT]

// TODO: [DEPENDENCY] Update React to version 18 for better performance and new features
// Long description to test title truncation at 80 character limit - this should be truncated

// TODO: [AUTOMATION] Improve GitHub Actions workflow for better CI/CD pipeline
// Test automation-related template labeling

// TODO: [BUILD] Optimize webpack configuration for faster build times
// Test build-related template with high priority labeling

export default function TestComponent() {
  // TODO: [UI/UX] Improve button hover effects and animations
  // Add smooth transitions and better visual feedback
  // Consider micro-interactions for better user experience

  return (
    <div>
      {/* FIX: [COMPONENT] Remove hardcoded styles and use CSS classes */}
      <h1 style={{ color: "red" }}>Test Component</h1>

      {/* TODO: [A11Y] Add proper ARIA labels for screen readers */}
